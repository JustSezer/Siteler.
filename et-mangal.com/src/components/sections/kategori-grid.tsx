          ...
          {kategoriler.map((k) => {
            ...
            return (
              <li key={k.slug}>
                <Link
                  href={k.href}
                  className="group grid gap-4 sm:gap-5 grid-cols-[64px_1fr] md:grid-cols-[96px_1fr_120px_auto] items-center py-6 sm:py-8 lg:py-10 px-2 sm:px-3 transition-colors hover:bg-paper-warm/60"
                >
