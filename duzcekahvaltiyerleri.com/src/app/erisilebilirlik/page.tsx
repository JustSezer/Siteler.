...
export const metadata: Metadata = {
  title: "Erişilebilirlik | Düzce Kahvaltı Yerleri",
  description:
    "Düzce Kahvaltı Yerleri erişilebilirlik bildirimi. WCAG 2.1 AA uyumluluğu, erişilebilirlik widget özellikleri ve klavye navigasyonu hakkında bilgi.",
  alternates: {
    canonical: "https://duzcekahvaltiyerleri.com/erisilebilirlik",
  },
};
      ...
      <main id="main-content" className="pt-28 pb-20 bg-background">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose-custom space-y-6 text-muted-foreground leading-relaxed">
            <p>
              D&uuml;zce Kahvalt&ı; Yerleri olarak, sitemizin engelli bireyler
              dahil herkes tarafından erişilebilir olmasını sağlamaya
              kararlıyız. Web Content Accessibility Guidelines (WCAG) 2.1 AA
              seviyesine uyum sağlamak için sürekli çalışıyoruz.
            </p>
            ...
            <p>
              ...
              <a
                href="mailto:info@duzcekahvaltiyerleri.com"
                className="text-primary underline"
              >
                info@duzcekahvaltiyerleri.com
              </a>{" "}
