...
export const metadata: Metadata = {
  title: "Çerez Politikası | Düzce Kahvaltı Rehberi",
  description: "Düzce Kahvaltı Rehberi çerez politikası.",
  alternates: {
    canonical: "https://duzcekahvaltiyerleri.com/cerez-politikasi",
  },
};
