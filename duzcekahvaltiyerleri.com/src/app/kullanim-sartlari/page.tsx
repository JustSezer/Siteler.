...
export const metadata: Metadata = {
  title: "Kullanım Şartları | Düzce Kahvaltı Rehberi",
  description: "Düzce Kahvaltı Rehberi kullanım şartları.",
  alternates: {
    canonical: "https://duzcekahvaltiyerleri.com/kullanim-sartlari",
  },
};
      ...
      <main className="pt-28 pb-20 bg-background">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose-custom space-y-6 text-muted-foreground leading-relaxed">
            ...
            <p>
              duzcekahvaltiyerleri.com (&quot;Site&quot;) web sitesini kullanarak bu
            ...
            <p>
              Sitedeki tüm metin, grafik ve tasarım öğeleri duzcekahvaltiyerleri.com
            ...
            <p>
              Sorularınız için{" "}
              <a
                href="mailto:merhaba@duzcekahvaltiyerleri.com"
                className="text-primary underline"
              >
                merhaba@duzcekahvaltiyerleri.com
              </a>{" "}
