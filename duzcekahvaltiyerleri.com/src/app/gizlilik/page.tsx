...
export const metadata: Metadata = {
  title: "Gizlilik Politikası | Düzce Kahvaltı Rehberi",
  description: "Düzce Kahvaltı Rehberi gizlilik politikası.",
  alternates: {
    canonical: "https://duzcekahvaltiyerleri.com/gizlilik",
  },
};
      ...
      <main className="pt-28 pb-20 bg-background">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose-custom space-y-6 text-muted-foreground leading-relaxed">
            ...
            <p>
              duzcekahvaltiyerleri.com (&quot;Site&quot;) ziyaretçilerinin gizliliğini
