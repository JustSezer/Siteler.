...
const posts = [
  {
    ...
    excerpt: "Food truck işine girmeden önce bilmeniz gereken tüm adımlar, maliyetler ve dikkat edilmesi gerekenler. Deneyimli bayilerimizin tavsiyesiyle.",
    date: "15 Ocak 2025",
    readTime: "7 dk",
    category: "Franchise",
  },
  ...
  },
  {
    ...
    excerpt: "Nereden çalışacağınız, ne kadar kazanacağınızı belirler. Lokasyon seçiminde dikkat etmeniz gereken kriterler.",
    date: "2 Nisan 2025",
    readTime: "4 dk",
    category: "Strateji",
  },
  {
    ...
    excerpt: "Bolu Dağı'nın efsane lezzetinin perde arkası. İbrahim Usta ve ailesinin tutkuyla koruduğu tarif.",
    date: "20 Nisan 2025",
    readTime: "8 dk",
    category: "Hikaye",
  },
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "1rem" }}>
              <span
                style={{
                  ...
                  textTransform: "uppercase", color: "var(--color-red)",
                  backgroundColor: "rgba(204,20,20,0.08)", padding: "0.2rem 0.6rem", borderRadius: "3px",
                }}
              >
                {post.category}
              </span>
